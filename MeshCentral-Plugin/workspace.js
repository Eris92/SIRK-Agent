...
module.exports.workspace = function workspacePlugin(parent) {
    ...
    obj.server_startup = function () { console.log('[MeshCentral-Workspace] Plugin 0.8.2 loaded'); };
    ...
    obj.onWebUIStartupEnd = function () {
        ...
        var endpoint = function (asset) { var url = new URL('pluginadmin.ashx', window.location.href); url.searchParams.set('pin', 'workspace'); url.searchParams.set('asset', asset); url.searchParams.set('v', '0.8.2'); return url.href; };
