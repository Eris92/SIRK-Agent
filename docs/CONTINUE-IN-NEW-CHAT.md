...
- Aktualny etap: `1.0.15` — binarny Pulpit dirty-region 120 Hz, narzedzia administracyjne SYSTEM, bezpieczne aktualizacje oraz Terminal i Pliki przez SIRK Agent
- Potwierdzony pakiet na komputerze `DELL_K`: `1.0.15`, Windows x64 framework-dependent .NET 8
...
8. dopiero po zielonym wyniku pobrac artefakt `SIRK-Agent-1.0.15-win-x64`.
