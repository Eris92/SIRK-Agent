...
text = text.replace(
    ...
    '            var clipboard = NativeClipboard.Read();', 1)
...
for forbidden in (
    'System.Windows.Forms', 'System.Windows.Automation', 'Screen.AllScreens',
    'SystemInformation.VirtualScreen', 'Cursor.Position', 'Clipboard.',
    'SendKeys.', 'AutomationElement', 'RunSta('):
    if forbidden in text:
        raise RuntimeError(f'dependency remains: {forbidden}')
