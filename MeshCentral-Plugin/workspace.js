...
module.exports.workspace = function workspacePlugin(parent) {
    ...
    obj.server_startup = function () { console.log('[MeshCentral-Workspace] Plugin 0.9.1 loaded'); };
    ...
    obj.onWebUIStartupEnd = function () {
        ...
        var endpoint = function (asset) { var url = new URL('pluginadmin.ashx', window.location.href); url.searchParams.set('pin', 'workspace'); url.searchParams.set('asset', asset); url.searchParams.set('v', '0.9.1-' + Date.now()); return url.href; };
